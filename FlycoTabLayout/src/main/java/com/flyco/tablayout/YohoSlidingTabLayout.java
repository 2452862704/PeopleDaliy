...
public class YohoSlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public YohoSlidingTabLayout(Context context) {
        this(context, null, 0);
    }

    public YohoSlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public YohoSlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setViewPager(ViewPager vp, String[] titles, FragmentActivity fa, ArrayList<Fragment> fragments) {
        ...
        this.mViewPager = vp;
        this.mViewPager.setAdapter(new YohoSlidingTabLayout.InnerPagerAdapter(fa.getSupportFragmentManager(), fragments, titles));
        this.mViewPager.removeOnPageChangeListener(this);
        this.mViewPager.addOnPageChangeListener(this);
        notifyDataSetChanged();
    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.layout_yoho_tab, null);
    ...
    public void addNewTab(String title) {
        View tabView = View.inflate(mContext, R.layout.layout_yoho_tab, null);
        if (mTitles != null) {
            mTitles.add(title);
        }
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    public void showMsg(int position, int num) {
        ...
        ImageView tipView =  tabView.findViewById(R.id.img_tab_yoho);
//        if (tipView != null) {
...
//        }
     ...
     * @param position 显示tab位置
     */
    public void showArrow(int position,int resID) {
        if (position >= mTabCount) {
            position = mTabCount - 1;
        }
        View tabView = mTabsContainer.getChildAt(position);
